...
const safeInvitation = { id: true, email: true, role: true, teamGroupId: true, teamGroup: { select: { id: true, name: true } }, expiresAt: true, createdAt: true, emailStatus: true, emailSentAt: true } as const;

export type NavigationIconName = "tasks" | "reminders" | "email" | "team" | "reports" | "notifications" | "menu" | "close";

const paths: Record<NavigationIconName, React.ReactNode> = {
  tasks: <><rect x="3.5" y="5" width="17" height="14" rx="2" /><path d="M7 9h10M7 13h6" /></>,
  reminders: <><path d="M18 9a6 6 0 0 0-12 0c0 7-3 7-3 9h18c0-2-3-2-3-9ZM10 21h4" /><path d="M12 3V1" /></>,
